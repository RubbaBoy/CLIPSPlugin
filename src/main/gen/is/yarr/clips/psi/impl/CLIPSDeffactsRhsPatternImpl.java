...
public class CLIPSDeffactsRhsPatternImpl extends CLIPSPsiElementImpl implements CLIPSDeffactsRhsPattern {

  public CLIPSDeffactsRhsPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CLIPSVisitor visitor) {
    visitor.visitDeffactsRhsPattern(this);
  }
  ...
  public CLIPSDefName getDefName() {
    return findNotNullChildByClass(CLIPSDefName.class);
  }
